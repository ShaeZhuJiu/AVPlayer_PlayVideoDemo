...
{
    [super viewDidLoad];
   // NSURL* videoUrl = [[NSBundle mainBundle] URLForResource:@"movie"
    //                                                          withExtension: @"mp4"];
    NSURL *videoUrl = [NSURL URLWithString:@"http://flv.bn.netease.com/videolib3/1707/03/bGYNX4211/SD/movie_index.m3u8"];
